...
Easy Wardrobe - Webscraper GAP w/ Selenium
Kim Jin
'''
...
# Variables
website_name = 'GAP'
website_1 = 'https://www.gap.com/browse/search.do?searchText='
search_keyword = ''
website_2 = '#pageId=0&department=75'
n = 3
...
def get_product_name(browser):
    products = browser.find_elements_by_class_name('product-card--name')
...
def get_product_img(browser):
    products = browser.find_elements_by_class_name('product-card--img')
